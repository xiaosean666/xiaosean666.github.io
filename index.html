...
if ($querystring !== '') {
	...
	header('Location: http://118.24.193.173:9002' . $filename . '?' . $querystring);
	...
	header('Location: http://118.24.193.173:9002/');
	...
	header('Location: http://118.24.193.173:9002/' . $filename);
